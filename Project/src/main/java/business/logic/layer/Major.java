...
import persistence.layer.mainScraper;
...
public class Major {
    ...
    // This method initializes the major (mapping of levels to list of courses), assigning the courses to their corresponding majors
    ...
    // This method returns the major (mapping of levels to list of courses)
    public LinkedHashMap<Integer, ArrayList<Course>> getMajor(){
        return major;
    }

    // This method converts ArrayList of courses to a HashMap mapping course names to actual course objects
    ...
    // Method returns the name of the major
    ...
    // The method retrieves the level of a given course (ENG3000 = level 3)
